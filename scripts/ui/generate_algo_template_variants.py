...
def voice_reg_common_rows(lang: str) -> List[List[Any]]:
    t = TEXT[lang]
    return [
        row(50, t.learn_command, t.learn_command, "命令词", t.learn_command_reply, "主", 0x50),
        row(51, t.learn_wakeup, t.learn_wakeup, "命令词", t.learn_wakeup_reply, "主", 0x51),
        row(52, t.delete_command, t.delete_command, "命令词", t.delete_command_reply, "主", 0x52),
        row(53, t.delete_wakeup, t.delete_wakeup, "命令词", t.delete_wakeup_reply, "主", 0x53),
        row(54, t.delete_all, t.delete_all, "命令词", t.delete_all_reply, "主", 0x54),
        row(55, t.exit_learning, t.exit_learning, "命令词", ("已退出学习" if lang == "zh" else "Learning exited"), "主", 0x55),
        row(56, t.exit_deletion, t.exit_deletion, "命令词", ("已退出删除" if lang == "zh" else "Deletion exited"), "主", 0x56),
...
def make_profiles() -> List[Profile]:
    profile_specs = [
        ...
        },
        {
            ...
            "purpose": "语音注册指定学习：学习命令词/唤醒词、删除、退出、全部删除、可学习目标命令。",
            ...
            "risk": "中：负例不能使用语音注册控制词，避免误触发真实功能。",
            "factory": voice_reg_specific_rows,
        },
        {
            "id": "voice_reg_continuous",
            "purpose": "语音注册连续学习：连续学习入口、直学/自动下一条、两步删除命令词、模板满后清理再学。",
        ...
        },
        {
            ...
            "purpose": "语音注册边界/删除：字数上下限、重试次数、模板上限、删除命令/唤醒词/全部删除闭环。",
            ...
            "parameters": BASE_PARAMS + VOICE_REG_PARAMS,
            "risk": "中：字数边界语料运行时合成，模板只提供入口和宿主动作。",
        ...
        },
        {
            ...
            "purpose": "综合状态包：基础功能 + 协议主动/被动 + 多唤醒指定切换 + 语音注册控制词。",
            ...
            "risk": "高：词量较多，3021 上如出现内存超限，应拆分为专项模板而不是压缩结论。",
